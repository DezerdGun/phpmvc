					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="?view=usercabin&id<?=$cab['id']?>"><i class="fa fa-phone"></i> <?=$cab['id']?></a></li>
								<li><a href="#"><i class="fa fa-user"></i> <?=$cab['name']?> </a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> <?=$cab['email']?></a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="<?=THEME?>images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="?view=login"><i class="fa fa-lock"></i> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<? $i = 0; foreach($head as $item){?>
									<li><a href="?view=<?=$item['href']?>" class="<? if($i == 0){echo'active';}?>"><?=$item['title']?></a></li>
								<?$i++;}?>
					...
					<div class="col-sm-3">
						...
						<form action="" method="get">
							...
							<input type="hidden" name="view" value="search"  placeholder="Search"/>
							<button type="button"  onclick="searchs()" class="btn btn-warning"  placeholder="Search">Search</button>
							</form>
						</div>
